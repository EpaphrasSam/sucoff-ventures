  ...
  return (
    <>
      <footer className="relative bg-dark-bg text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24 grid gap-12 lg:grid-cols-3 md:grid-cols-2">
          {/* Company Info */}
          <div>
            ...
            <p className="text-slate-300 leading-relaxed mb-6">
              Building and civil engineering focused on quality, safety, and
              reliability across Ghana since 2015.
            </p>
            <div className="space-y-3">
              <div className="flex items-start gap-2 text-sm text-slate-400">
                <FiMapPin className="w-4 h-4 text-primary shrink-0 mt-0.5" />
                <span>Goaso-Bechem, Ahafo Region</span>
              </div>
              <a
              ...
              <a
                ...
                className="flex items-center gap-2 text-sm text-slate-400 hover:text-primary transition-colors break-all"
              >
