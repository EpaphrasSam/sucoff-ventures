      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          ...
          <div className="space-y-6 text-lg text-slate-700 leading-relaxed">
            <p>
              Our portfolio showcases a diverse range of successfully completed
              projects that demonstrate our commitment to quality, innovation,
              and timely delivery. From road construction in the Bono Region to
              educational facilities across multiple districts, each project
              reflects our dedication to building Ghana&apos;s infrastructure.
            </p>
            <p>
              We have successfully executed projects including road construction
              at Berekum East Municipal, primary school facilities in Jaman
              South and Kwawu South districts, and special projects such as an
              AstroTurf facility at Odumase. Each project is delivered with the
              same commitment to quality, safety, and client satisfaction.
            </p>
            <p className="text-slate-600">
              Our project delivery approach combines technical expertise, modern
              equipment, skilled workforce, and rigorous quality control to
              ensure that every structure we build stands the test of time while
              meeting all regulatory and client requirements.
            </p>
          </div>
        </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8">
              ...
              <p className="text-slate-200 text-lg leading-relaxed">
                Building critical infrastructure that connects communities and
                drives economic growth across Ghana&apos;s regions.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-linear-to-br from-primary/5 to-blue-50 rounded-2xl p-8 border border-primary/20">
              ...
              <p className="text-muted leading-relaxed mb-4">
                We have successfully delivered projects across multiple regions
                in Ghana, including Bono Region, Jaman South District, and Kwawu
                South District.
              </p>
            ...
            <div className="bg-linear-to-br from-accent/5 to-orange-50 rounded-2xl p-8 border border-accent/20">
              ...
              <p className="text-muted leading-relaxed">
                Our expertise spans road construction, educational facilities,
                institutional buildings, and specialized sports infrastructure
                projects.
              </p>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div
                  className={`w-12 h-12 rounded-lg bg-linear-to-br ${category.color} p-3 mx-auto mb-4`}
                >
