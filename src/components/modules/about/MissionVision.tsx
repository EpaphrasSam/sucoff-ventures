...
export default function MissionVision() {
  return (
    <section className="bg-linear-to-b from-white to-slate-50 py-20 md:py-32">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <motion.div
            ...
            className="group"
          >
            <div className="h-full bg-linear-to-br from-blue-50 to-white rounded-2xl p-10 border border-slate-200 hover:border-primary/30 shadow-lg hover:shadow-2xl transition-all duration-500">
          ...
          <motion.div
            ...
            className="group"
          >
            <div className="h-full bg-linear-to-br from-orange-50 to-white rounded-2xl p-10 border border-slate-200 hover:border-accent/30 shadow-lg hover:shadow-2xl transition-all duration-500">
