        ...
        >
          {team.map((m) => (
            <motion.div
              ...
              className="group"
            >
              <div className="h-full rounded-2xl bg-linear-to-br from-slate-50 to-white border border-slate-200 hover:border-primary/30 shadow-lg hover:shadow-2xl transition-all duration-500 p-6">
